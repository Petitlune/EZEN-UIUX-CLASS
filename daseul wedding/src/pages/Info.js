...
import ModalGroom from "../components/ModalGroom";
import ModalDaseul from "../components/ModalDaseul";
...
const InfoImg = styled.img`
  ...
  margin-bottom: 20px;
`;
const Info = ({ Subtitle, SubtitleKR, DateInfo }) => {
      ...
      <Container>
        ...
        <Infomation>
          <InfoInner>
            ...
            {isModalOpen && <ModalGroom onClose={handleCloseModal} />}
          </InfoInner>
          <InfoInner>
            <Title>
              <img src="./img/flower.png" alt="flower" />
            ...
            {isModalBrideOpen && (
              <ModalDaseul onClose={handleCloseBrideModal} />
            )}
          </InfoInner>
        </Infomation>
